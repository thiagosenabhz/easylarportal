  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 right-6 z-40 flex h-16 w-16 items-center justify-center rounded-2xl bg-[#25D366] shadow-lg transition hover:scale-105 focus:outline-none focus:ring-2 focus:ring-white/60 focus:ring-offset-2 focus:ring-offset-[#25D366]"
      >
        <Image
          src="/whatsapp.png"
          alt="WhatsApp"
