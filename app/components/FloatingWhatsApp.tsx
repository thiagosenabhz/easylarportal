...
type FloatingWhatsAppProps = {
  /**
   * Opcional: se for passado, o clique chama essa função
   * (por exemplo, para abrir um LeadModal global externo).
   * Se não for passado, o próprio componente abre um LeadModal interno.
   */
...
export default function FloatingWhatsApp({
  ...
  return (
    <>
      ...
      >
        {/* Ícone clássico do WhatsApp em SVG (vetor) */}
        <svg
      ...
      {/* Modal local, usado quando nenhuma função externa é passada */}
      {!onOpenLeadModal && (
        <LeadModal
